 ...
 * ZenoVisualization
 * ------------------
 * Premium CSS/SVG hero illustration for the ZENO login page.
 * Real ZENO logo inlined inside the central orb.
...
/* ZENO logo paths normalised from light-logo.svg
...
export function ZenoVisualization({ isDark, className = '' }: Props) {
  ...
  return (
    ...
    >
      ...
      {/* Real ZENO logo clipped inside orb — always light-logo colors */}
