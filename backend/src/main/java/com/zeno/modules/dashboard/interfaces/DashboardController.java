package com.zeno.modules.dashboard.interfaces;

import com.zeno.config.SecurityUtils;
import com.zeno.modules.dashboard.application.DashboardService;
import com.zeno.modules.dashboard.interfaces.dto.DashboardResponse;
...
@Tag(name = "Dashboard", description = "Aggregate platform metrics for the Zeno frontend")
