...
import com.zeno.shared.api.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ZenoException.class)
    public ResponseEntity<ErrorResponse> handleZenoException(ZenoException ex) {
        log.debug("ZenoException [{}]: {}", ex.getCode(), ex.getMessage());
