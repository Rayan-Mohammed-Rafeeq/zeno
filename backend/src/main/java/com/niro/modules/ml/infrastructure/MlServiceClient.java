 ...
 * 2. Bounded timeout: configurable via niro.ml.timeout-seconds (default 5s).
...
public class MlServiceClient {
    ...
    public MlPredictionResponse predict(MlPredictionRequest request) {
        NiroProperties.Ml mlConfig = properties.getMl();
    ...
    private RestClient buildClient(NiroProperties.Ml config) {
