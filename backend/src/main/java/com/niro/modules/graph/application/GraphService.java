...
import com.niro.modules.graph.domain.*;
import com.niro.modules.graph.infrastructure.JpaClusterMemberRepository;
import com.niro.modules.graph.infrastructure.JpaRiskClusterRepository;
import com.niro.modules.graph.interfaces.dto.*;
...
public class GraphService {
    ...
    public GraphResponse getClusterGraph(UUID merchantId, UUID clusterId) {
        ...
        Map<UUID, List<com.niro.modules.payment.domain.Payment>> paymentsByCustomer = customerIds.stream()
        ...
        for (UUID customerId : customerIds) {
            ...
            List<com.niro.modules.payment.domain.Payment> payments =
                    paymentsByCustomer.getOrDefault(customerId, List.of());

            Set<String> devices = new HashSet<>();
            Set<String> ips     = new HashSet<>();

            for (com.niro.modules.payment.domain.Payment p : payments) {
