package com.niro.modules.evaluation.interfaces.dto;
...
public record EvaluationRunResponse(
    ...
    public static EvaluationRunResponse from(EvaluationRun r, NiroProperties.Evaluation.FalsePositiveCost costs) {
