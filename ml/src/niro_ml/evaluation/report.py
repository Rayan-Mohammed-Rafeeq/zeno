...
from niro_ml.evaluation.metrics import EvaluationMetrics
...
class BenchmarkReport:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {
            ...
            "niro_version":   self.niro_version,
            "dataset": {
    ...
    def to_text(self) -> str:
        ...
        lines += [
            "╔══════════════════════════════════════════════════════════════════════╗",
            "║              NIRO FRAUD DETECTION — BENCHMARK REPORT               ║",
            "╚══════════════════════════════════════════════════════════════════════╝",
            "",
            f"Generated : {self.generated_at}",
            f"Version   : {self.niro_version}",
        ]
